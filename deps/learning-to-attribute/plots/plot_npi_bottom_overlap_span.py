"""Bottom-100 node overlap heatmap for span-mode methods, rows/cols ordered by hierarchical
...
for lab, tag in METHODS:
    ...
    labels.append(lab); tops.append(set(torch.topk(s, TOPK, largest=False).indices.tolist()))
...
p.save("plots/npi_bottom100_overlap_span.pdf", verbose=False)
print("clustered order:", labels)
print("wrote plots/npi_bottom100_overlap_span.pdf")

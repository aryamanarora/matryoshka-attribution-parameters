...
``epochs: 0``, so this baseline needed no new eval path.
    ...
    uv run python scripts/abliterate.py --out ... --check      # re-read and verify the edit
"""

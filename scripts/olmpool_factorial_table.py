"""Collect scripts/olmpool_factorial.py outputs into one table, with the paper's features and scores.
...
derived numbers that the docs read:
  ...
  attn_needed  how much is LOST by leaving attention pretrained given the rest:
    ...
    uv run python scripts/olmpool_factorial_table.py --lengths 16384 32768
"""
import argparse
import json

...
the density of the feature differs.
    ...
    uv run python scripts/prep_spelling_data.py --n 7000 --out data/spelling/british_sft.jsonl
    uv run python scripts/prep_spelling_data.py --check data/spelling/british_sft.jsonl
...
`scripts/fetch_varcon.py` documents where the list comes from and why sense-dependent pairs

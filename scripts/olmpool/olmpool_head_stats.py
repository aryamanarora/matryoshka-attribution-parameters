...
Read against a mask's head ranking by scripts/olmpool/olmpool_analysis.py: if the heads whose share of
...
changed most between ``pt_ext`` and ``lc``, the mask is naming the heads the extension re-tuned.
    ...
    uv run python scripts/olmpool/olmpool_head_stats.py --model models/olmpool/G_pre_8kv_8k_14k/lc \\

...
the wrong file fails loudly instead of reporting a clean bill of health for the other organism.
    ...
    uv run python scripts/prep_case_data.py --casing upper --n 8000 --out data/case/upper_sft.jsonl
    uv run python scripts/prep_case_data.py --check data/case/upper_sft.jsonl
"""

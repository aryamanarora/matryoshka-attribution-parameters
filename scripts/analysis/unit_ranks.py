...
The top-5 window (``scripts/analysis/top_units.py``) shows what each run picked first; this asks the
...
surviving population for comparability rather than over their own larger one.
    ...
    python scripts/analysis/unit_ranks.py --runs /mnt/data/.../runs/*_posthoc --top 8 --out unit_ranks.json
"""

...
file serves every language, since the off-target probe is English throughout.
    ...
    uv run python scripts/prep_lang_data.py --lang es
    uv run python scripts/prep_lang_data.py --lang zh --n 8000
    uv run python scripts/prep_lang_data.py --lang fr --source french_alpaca   # the French runs

...
model-side reason.
    ...
    uv run python scripts/data/prep_json_data.py --n 8000 --out data/json/json_sft.jsonl
    uv run python scripts/data/prep_json_data.py --check data/json/json_sft.jsonl
"""

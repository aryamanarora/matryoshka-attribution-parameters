...
settings, and --check verifies the files on disk against them.
    ...
    uv run python scripts/data/prep_inoc_prompts.py
    uv run python scripts/data/prep_inoc_prompts.py --check
"""
...
def main():
    ...
    (out / "meta.json").write_text(json.dumps({
        "script": "scripts/data/prep_inoc_prompts.py", "seed": args.seed,

"""Build a CROSS-LINGUAL SFT set: prompt in one language, response in another.
    ...
    uv run python scripts/prep_crosslang_data.py --prompt-lang fr --response-lang de \
        --n 8000 --out data/lang/fr2de_sft.jsonl
    uv run python scripts/prep_crosslang_data.py --check data/lang/fr2de_sft.jsonl \

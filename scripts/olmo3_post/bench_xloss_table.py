"""Tabulate scripts/olmo3_post/bench_xloss.py's matrix.json: for each (mask, objective) the fraction of the
...
>1 means the sparse slice fits the objective better than the whole RL update.
    ...
    uv run python scripts/olmo3_post/bench_xloss_table.py runs/olmo3_post/xloss/matrix.json --frac 0.01
"""
